...
- docs that must stay aligned: `docs/MODULE_INDEX.md`, `docs/ARCHITECTURE.md`, `docs/TESTING.md`, `README.md`, submodule cards under `app/*`; when the shared `services/observability.py` contract changes, update all three service Dockerfiles (they copy it) in the same change.
