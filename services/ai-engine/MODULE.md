...
- product/module functionality: provider health/config, generation, embeddings, LanceDB persistence, document indexing/search, cluster labeling.
...
- docs that must stay aligned: `docs/AI_CONFIG.md`, `docs/ARCHITECTURE.md`, `README.md`, provider submodule card.
- local validation commands/checks: `make test-ai`; then integration smoke for `/health`, `/providers`, indexing, and chat/search changes.
