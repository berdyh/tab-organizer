#!/bin/bash
# Comprehensive test runner for clustering service.
...
print_status "Running clustering service tests in mode: $MODE"

case $MODE in
    "docker")
        print_status "Building clustering service test image..."
        
        # Build the clustering service image
        docker build -t clustering-service-test ./services/clustering
    ...
    "stack")
        ...
        # Run tests in clustering service
